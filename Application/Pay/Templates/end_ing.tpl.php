    ...
    <tr>
    	<td>
    		<div class="explain-col">	
				...
				<br><br>
				返利已下架总数:<font color="green"><?php echo $end_rebate_count?$end_rebate_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用已下架总数：<font color="green"><?php echo $end_trial_count?$end_trial_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				佣金已下架总数：<font color="green"><?php echo $end_commission_count?$end_commission_count:0; ?></font>&nbsp;&nbsp;&nbsp;
<!-- 				日赚任务已下架总数：<font color="green"><?php echo $end_task_count?$end_task_count:0; ?></font>&nbsp;&nbsp;&nbsp;
 -->			</div>
		</td>
		</tr>
    </tbody>
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">返利已下架</th>
			<th width="100">试用已下架</th>
<!-- 			<th width="100">日赚任务已下架</th>
 -->			<th width="100">闪电佣金已下架</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_rebate_end_mum'];?></td>
			<td align='center'><?php echo $r['day_trial_end_mum'] ?></td>
<!-- 			<td align='center'><?php echo $r['day_task_end_mum'] ?></td>
 -->			<td align='center'><?php echo $r['day_commission_end_mum'] ?></td>
