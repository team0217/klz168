    ...
    <tr>
    	<td>
    		<div class="explain-col">	
				...
				<br><br>
				平台注册用户总数:<font color="green"><?php echo $register_count?$register_count:0; ?></font>&nbsp;&nbsp;&nbsp;
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">今日平台注册用户数 </th>
<!-- 			<th width="100">今日app注册数</th>
...
<!-- 			<td align='center' ><?php echo $r['day_trial_Apply'];?></td>
 -->
			...
			<td align='center'><?php echo $r['day_reg'] ?></td>
