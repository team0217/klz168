    ...
    <tr>
    	<td>
    		<div class="explain-col">	
				...
				<br><br>
				返利待上线总数:<font color="green"><?php echo $wait_rebate_count?$wait_rebate_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用待上线总数：<font color="green"><?php echo $wait_trial_count?$wait_trial_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				佣金待上线总数：<font color="green"><?php echo $wait_commission_count?$wait_commission_count:0; ?></font>&nbsp;&nbsp;&nbsp;
<!-- 				日赚任务待上线总数：<font color="green"><?php echo $wait_task_count?$wait_task_count:0; ?></font>&nbsp;&nbsp;&nbsp;
 -->			</div>
		</td>
		</tr>
    </tbody>
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">返利待上线</th>
			<th width="100">试用待上线</th>
			<th width="100">闪电佣金待上线</th>
<!-- 			<th width="100">日赚任务待上线</th>
 -->            <th width="118">统计时间</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_rebate_Stay_mum'];?></td>
			<td align='center'><?php echo $r['day_trial_Stay_mum'] ?></td>
			<td align='center'><?php echo $r['day_commission_Stay_mum'] ?></td>
<!-- 			<td align='center'><?php echo $r['day_task_Stay_mum'] ?></td>
