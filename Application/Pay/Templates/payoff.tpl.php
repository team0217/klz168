    	...
    	<td>
    		<div class="explain-col">	
				...
				<input type="submit" name="searchbtn" class="button" value="<?php echo L('search');?>" />
					...
					<br><br>
				买家缴纳vip总金额:<font color="green"><?php echo $buyer_count?$buyer_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				卖家升级vip总金额：<font color="green"><?php echo $seller_count?$seller_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用完成手续费：<font color="green"><?php echo $trial_count?$trial_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				返利完成手续费：<font color="green"><?php echo $rebate_count?$rebate_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				闪电完成手续费：<font color="green"><?php echo $commission_count?$commission_count:0; ?></font>&nbsp;&nbsp;&nbsp;
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">买家缴纳vip</th>
			<th width="100">卖家升级vip</th>
			<th width="100">试用完成手续费</th>
			<th width="100">返利完成手续费</th>
			<th width="100">闪电完成手续费</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_Buyers_vip'];?></td>
			<td align='center'><?php echo $r['day_seller_vip'] ?></td>
			<td align='center'><?php echo $r['day_trial_Complete_Counter_Fee'] ?></td>
			<td align='center'><?php echo $r['day_rebate_Complete_Counter_Fee'] ?></td>
			<td align='center'><?php echo $r['day_commission_Complete_Counter_Fee'] ?></td>
