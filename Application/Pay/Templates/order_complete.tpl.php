    ...
    <tr>
    	<td>
    		<div class="explain-col">	
				...
				<br><br>
				试用完成总数：<font color="green"><?php echo $compelte_trial_count?$compelte_trial_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				佣金完成总数：<font color="green"><?php echo $compelte_commission_count?$compelte_commission_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				购物返利完成总数：<font color="green"><?php echo $compelte_rebate_count?$compelte_rebate_count:0; ?></font>&nbsp;&nbsp;&nbsp;
<!-- 				赚任务完成总数：<font color="green"><?php echo $compelte_task_count?$compelte_task_count:0; ?></font>&nbsp;&nbsp;&nbsp;
 -->			</div>
		</td>
		</tr>
    </tbody>
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">今日试用完成数</th>
			<th width="100">闪电佣金完成数</th>
			<th width="100">购物返利完成数量</th>
<!-- 			<th width="100">日赚任务完成数量</th>
 -->            <th width="118">统计时间</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_trial_Complete'];?></td>
			<td align='center'><?php echo $r['day_commission_Complete'] ?></td>
			<td align='center'><?php echo $r['day_rebate_Complete'] ?></td>
		<!-- 	<td align='center'><?php echo $r['day_task_Complete'] ?></td> -->
