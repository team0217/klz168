    	...
    	<td>
    		<div class="explain-col">	
				...
				<input type="submit" name="searchbtn" class="button" value="<?php echo L('search');?>" />
						<br><br>
				返利完成总金额:<font color="green"><?php echo $end_money_rebate?$end_money_rebate:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用完成总金额：<font color="green"><?php echo $end_money_trial?$end_money_trial:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用完成红包总金额：<font color="green"><?php echo $end_money_bonus?$end_money_bonus:0; ?></font>&nbsp;&nbsp;&nbsp;
				闪电试用完成金额：<font color="green"><?php echo $end_money_task?$end_money_task:0; ?></font>&nbsp;&nbsp;&nbsp;
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">今日返利完成金额</th>
			<th width="100">试用完成金额</th>
			<th width="100">试用完成红包</th>
			<th width="100">闪电试用完成金额</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_rebate_Complete_money'];?></td>
			<td align='center'><?php echo $r['day_trial_Complete_money'] ?></td>
			<td align='center'><?php echo $r['day_trial_Red'] ?></td>
			<td align='center'><?php echo $r['day_commission_Complete_money'] ?></td>
