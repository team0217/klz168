    	...
    	<td>
    		<div class="explain-col">	
				...
				<input type="submit" name="searchbtn" class="button" value="<?php echo L('search');?>" />
					...
					<br><br>
				返利退还保证金总数:<font color="green"><?php echo $back_rebate_count?$back_rebate_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用退还保证金总数：<font color="green"><?php echo $back_trial_count?$back_trial_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				佣金退还保证金总数：<font color="green"><?php echo $back_commission_count?$back_commission_count:0; ?></font>&nbsp;&nbsp;&nbsp;
<!-- 				日赚任务退还保证金总数：<font color="green"><?php echo $back_task_count?$back_task_count:0; ?></font>&nbsp;&nbsp;&nbsp;
 -->			</div>
		</td>
		</tr>
    </tbody>
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">返利退还保证金</th>
			<th width="100">试用退还保证金</th>
			<th width="100">闪电佣金退还保证金</th>
<!-- 			<th width="100">日赚任务退还保证金</th>
 -->            <th width="118">统计时间</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_rebate_refund_deposit'];?></td>
			<td align='center'><?php echo $r['day_trial_refund_deposit'] ?></td>
			<td align='center'><?php echo $r['day_commission_refund_deposit'] ?></td>
<!-- 			<td align='center'><?php echo $r['day_task_refund_deposit'] ?></td>
