...
<?php if ($_GET['mod'] == 'rebate'): ?>
		<a class="add fb" href="<?php echo U('add') ?>"><em>发布活动（商品）</em></a>

<?php elseif ($_GET['mod'] == 'trial'): ?>
<a class="add fb" href="<?php echo U('add', array('mod' => 'trial')) ?>"><em>发布活动（商品）</em></a>
<?php elseif ($_GET['mod'] == 'postal'): ?>
<a class="add fb" href="<?php echo U('add', array('mod' => 'postal')) ?>"><em>发布活动（商品）</em></a>
<?php elseif ($_GET['mod'] == 'commission'): ?>
<a class="add fb" href="<?php echo U('add', array('mod' => 'commission')) ?>"><em>发布活动（商品）</em></a>
<?php endif ?>	
