	function editor($field, $value, $fieldinfo) {
		...
		return "<div id='{$field}_tip'></div>".'<textarea name="info['.$field.']" id="'.$field.'" boxid="'.$field.'">'.htmlspecialchars_decode($value).'</textarea>'.$form::editor($field,$toolbar,'document',$this->catid,'',$allowupload,1,'',$height,$disabled_page);
	}
