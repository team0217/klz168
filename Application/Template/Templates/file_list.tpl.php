...
<form action="<?php echo U('updatefilename', array('style' => $this->style)) ?>" method="post">
...
<?php if ($dir !='' && $dir != '.'):?>
<tr>
<td align="left" colspan="3"><a href="<?php echo U('init', array('style' => $this->style, 'dir' => stripslashes(dirname($dir)))); ?>"><img src="<?php echo IMG_PATH?>folder-closed.gif" /><?php echo L("parent_directory")?></a></td>
</tr>
<?php endif;?>
<?php 
if(is_array($list)):
