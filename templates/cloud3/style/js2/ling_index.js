...
function(b) {
    b.fn.slide = function(a) {
        ...
        this.each(function() {
            ...
            ap = b(ag.prevCell, aj),
            at = b(ag.nextCell, aj),
            aw = b(ag.pageStateCell, aj),
            az = b(ag.playStateCell, aj),
            aC = b(ag.titCell, aj),
            aF = aC.size(),
            aI = b(ag.mainCell, aj),
            aK = aI.children().size(),
            aM = ag.switchLoad,
            aO = b(ag.targetCell, aj),
            aQ = parseInt(ag.defaultIndex),
            aS = parseInt(ag.delayTime),
            aU = parseInt(ag.interTime);
            parseInt(ag.triggerTime);
            var aT, aX = parseInt(ag.scroll),
            aZ = parseInt(ag.vis),
            ...
            ae = "false" == ag.returnDefault || 0 == ag.returnDefault ? !1 : !0,
            ah = 0,
            ak = 0,
            an = 0,
            aq = 0,
            ...
            aA = null,
            aD = null,
            aG = ag.titOnClassName,
            aJ = aC.index(aj.find("." + aG)),
            aL = aQ = -1 == aJ ? aQ: aJ,
            aN = aQ,
            aP = aQ,
            aR = aK >= aZ ? 0 != aK % aX ? aK % aX: aX: 0,
            aV = "leftMarquee" == am || "topMarquee" == am ? !0 : !1,
            aW = function() {
            ...
            a0 = function() {
                aC.removeClass(aG),
                ac && aC.eq(aN).addClass(aG)
            };
            if ("menu" == ag.type) {
                return ac && aC.removeClass(aG).eq(aQ).addClass(aG),
                aC.hover(function() {
            ...
            if (0 == aF && (aF = aK), aV && (aF = 2), a5) {
                if (aK >= aZ) {
                    if ("leftLoop" == am || "topLoop" == am) {
                        ...
                        var a2 = aK - aZ;
                        aF = 1 + parseInt(0 != a2 % aX ? a2 / aX + 1 : a2 / aX),
                        0 >= aF && (aF = 1)
                    }
                } else {
                    aF = 1
            ...
            if (aK >= aZ) {
                aI.children().each(function() {
                    b(this).width() > an && (an = b(this).width(), ak = b(this).outerWidth(!0)),
                    b(this).height() > aq && (aq = b(this).height(), ah = b(this).outerHeight(!0))
                });
                var a8 = aI.children(),
                ba = function() {
                    for (var c = 0; aZ > c; c++) {
                ...
                case "top":
                    ...
                    break;
                case "left":
                    aI.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; width:1195px"></div>').css({
                        width:
                        aK * ak,
                        left: -(aQ * aX) * ak,
                        position: "relative",
            ...
            var s = function(c) {
                var d = c * aX;
                return c == aF ? d = aK: -1 == c && 0 != aK % aX && (d = -aK % aX),
                d
            },
            aa = function(e) {
                var i = function(f) {
            ...
            ad = function(e) {
                if (!ac || aL != aQ || e || aV) {
                    if (aV ? aQ >= 1 ? aQ = 1 : 0 >= aQ && (aQ = 0) : (aP = aQ, aQ >= aF ? aQ = 0 : 0 > aQ && (aQ = aF - 1)), aW(), null != aM && aa(aI.children()), aO[0] && (aT = aO.eq(aQ), null != aM && aa(aO), "slideDown" == am ? (aO.not(aT).stop(!0, !0).slideUp(aS), aT.slideDown(aS, au,
                    function() {
                        aI[0] || aY()
                    })) : (aO.not(aT).stop(!0, !0).hide(), aT.animate({
                        opacity: "show"
                    },
                    aS,
                    function() {
                        ...
                        switch (am) {
                        case "fade":
                            aI.children().stop(!0, !0).eq(aQ).animate({
                                opacity: "show"
                            },
                            aS, au,
                            function() {
                        ...
                        case "leftLoop":
                            ...
                            aS, au,
                            function() { - 1 >= f ? aI.css("left", -(aR + (aF - 1) * aX) * ak) : f >= aF && aI.css("left", -aR * ak),
                                aY()
                            });
                            break;
                        case "topLoop":
                            ...
                            aS, au,
                            function() { - 1 >= f ? aI.css("top", -(aR + (aF - 1) * aX) * ah) : f >= aF && aI.css("top", -aR * ah),
                                aY()
                            });
                            break;
                        case "leftMarquee":
                    ...
                    aC.removeClass(aG).eq(aQ).addClass(aG),
                    aL = aQ,
                    a7 || (at.removeClass("nextStop"), ap.removeClass("prevStop"), 0 == aQ && ap.addClass("prevStop"), aQ == aF - 1 && at.addClass("nextStop")),
                    aw.html("<span>" + (aQ + 1) + "</span>/" + aF)
                }
            };
            ac && ad(!0),
            ae && aj.hover(function() {
            ...
            function() {
                aD = setTimeout(function() {
                    aQ = aN,
                    ac ? ad() : "slideDown" == am ? aT.slideUp(aS, a0) : aT.animate({
                        opacity: "hide"
                    },
                    aS, a0),
                    aL = aQ
            ...
            ao = function() { (a7 || aQ != aF - 1) && (aQ++, ad(), aV || al())
            },
            ar = function() { (a7 || 0 != aQ) && (aQ--, ad(), aV || al())
            },
            av = function() {
                clearInterval(ax),
                aV ? ai() : af(),
                az.removeClass("pauseState")
            },
            ay = function() {
                clearInterval(ax),
                az.addClass("pauseState")
            };
            ...
            function() {
                ...
                "mouseover" == ag.trigger && (at.hover(ao,
                function() {}), ap.hover(ar,
                function() {}))
            } else {
                at.click(ao),
                ap.click(ar)
...
jQuery.extend(jQuery.easing, {
    ...
    easeOutBack: function(g, h, i, j, k, l) {
        return void 0 == l && (l = 1.70158),
        j * ((h = h / k - 1) * h * ((l + 1) * h + l) + 1) + i
    },
    easeInOutBack: function(g, h, i, j, k, l) {
        return void 0 == l && (l = 1.70158),
        (h /= k / 2) < 1 ? j / 2 * h * h * (((l *= 1.525) + 1) * h - l) + i: j / 2 * ((h -= 2) * h * (((l *= 1.525) + 1) * h + l) + 2) + i
    },
...
function initHoverApply() {
    $(".titler_one ul li").hover(function() {
        ...
        $(this).find(".rsp_one").stop().animate({
            top: "0"
        },
        {
            duration: 500
...
function initAnnounceStyle() {
    var a = "usual1_1";
    var b = "usual1_a1";
    document.getElementById("usual1_a" + 1).onmouseover = function() {
        var c = "usual1_" + 1;
        var d = "usual1_a" + 1;
        if (c != a) {
            document.getElementById(c).style.display = "inline";
            document.getElementById(d).className = "seledt";
    ...
    document.getElementById("usual1_a" + 2).onmouseover = function() {
        var c = "usual1_" + 2;
        var d = "usual1_a" + 2;
        if (c != a) {
            document.getElementById(c).style.display = "inline";
    ...
    document.getElementById("usual1_a" + 3).onmouseover = function() {
        var c = "usual1_" + 3;
        var d = "usual1_a" + 3;
        if (c != a) {
            document.getElementById(c).style.display = "inline";
...
function initReportStyle() {
    ...
    a.fn.lazyload = function(h) {
        ...
        function j() {
            ...
            g.each(function() {
                var l = a(this);
                if (i.skip_invisible && !l.is(":visible")) {
                    return
                }
                if (a.abovethetop(this, i) || a.leftofbegin(this, i)) {} else {
                    if (!a.belowthefold(this, i) && !a.rightoffold(this, i)) {
                        l.trigger("appear");
                        k = 0
                    } else {
                        if (++k > i.failure_limit) {
                            return false
                        }
                    }
                }
        ...
        f = (i.container === d || i.container === e) ? b: a(i.container);
        ...
        this.each(function() {
            ...
            var k = a(l);
            l.loaded = false;
            if (k.attr("src") === d || k.attr("src") === false) {
                if (k.is("img")) {
                    k.attr("src", i.placeholder)
                }
            }
            k.one("appear",
            function() {
                if (!this.loaded) {
                    ...
                    a("<img />").bind("load",
                    function() {
                        var o = k.attr("data-" + i.data_attribute);
                        k.hide();
                        if (k.is("img")) {
                            k.attr("src", o)
                        } else {
                    ...
                    }).attr("src", k.attr("data-" + i.data_attribute))
                }
            });
            if (0 !== i.event.indexOf("scroll")) {
                k.bind(i.event,
    ...
    a.belowthefold = function(f, h) {
        ...
        if (h.container === d || h.container === e) {
            g = (e.innerHeight ? e.innerHeight: b.height()) + b.scrollTop()
        } else {
