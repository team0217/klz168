...
<html>
	<head>
		<meta charset="utf-8">
		<title><?php echo get_seo('all_seo','all_title','');?></title>
		<meta name="keywords" content="<?php echo get_seo('all_seo','all_keyword','');?>">
		<meta name="description" content="<?php echo get_seo('all_seo','all_description','');?>">
					...
					<div class="li_2_wrap">
						...
						<div class="title clear">
							...
							<div class="fl clear a2">
								...
								<a href="javascript:;" data-mod="rebate"><?php echo C('REBATE_NAME');?></a><b></b>
								<?php } ?>
			    ...
			    $.getJSON(site.site_root + '/index.php?m=product&c=api&a=v2_getlists', param, function(ret) {
			       ...
			       if(ret.status == 1) {
			           $.each(ret.data.lists, function(i, n) {
			              ...
			              _html += '</dd></dl>';
			              if(n.mod == 'rebate'){
			               _html += '<a href="'+n.url+'" class="b_btn" target="_bank">我要抢购</a></div>';
			           }else{
