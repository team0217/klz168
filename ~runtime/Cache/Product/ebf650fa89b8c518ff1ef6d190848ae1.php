			    ...
			    $.getJSON(site.site_root + '/index.php?m=product&c=api&a=v2_getlists', param, function(ret) {
			       ...
			       if(ret.status == 1) {
			           $.each(ret.data.lists, function(i, n) {
			               ...
			               _html += '<img src="'+n.thumb+'" alt="" style="width:100%; height:198px; min-height:198px; _height:198px;" />';
			               _html += '<div class="ts">';
			   				 var  money =  (parseFloat(n.goods_bonus)+ parseFloat(n.goods_price)).toFixed(2); 
                          ...
                          /* var divstyle = '';
                           ...
                           if(n.goods_bonus == '0.00' && n.goods_tryproduct == '0') {
                            ...
                            _html += '<p class="p1" style="color:#fff">佣金</p>';
                           _html += '<p class="p2" style="color:#fff">'+(parseFloat(n.goods_bonus)).toFixed(2)+'</p>';
			              ...
			              _html += '<p class="sy">剩余份数：<b class="cc">'+n.number+'</b>/<span>'+n.goods_number+'</span></p>';
			               _html += '<a href="'+n.url+'" class="btn" target="_blank" >我要试用</a></div></div>';
