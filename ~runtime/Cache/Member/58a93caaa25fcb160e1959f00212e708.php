...
<head>
	...
	<meta name="keywords" content="活动管理,商家个人中心,日赚任务产品,<?php echo C('WEBNAME');?>" />
	<meta name="description" content="活动管理,商家个人中心,日赚任务产品,<?php echo C('WEBNAME');?>" />
	...
	<link rel="stylesheet" href="<?php echo THEME_STYLE_PATH;?>style/css2/shops_vip_style.css" />
	<link rel="stylesheet" href="<?php echo THEME_STYLE_PATH;?>style/css2/release_shop.css" />
	<link rel="stylesheet" href="<?php echo THEME_STYLE_PATH;?>style/css2/demo.css" />
	<script language="javascript" type="text/javascript" src="<?php echo JS_PATH?>formvalidator.js" charset="UTF-8">
	</script>
	<script language="javascript" type="text/javascript" src="<?php echo JS_PATH?>formvalidatorregex.js" charset="UTF-8"></script>
	<style type="text/css">
	.input_width_1{ height:42px; }
	.right_release{ margin-left:100px; }
	.shop_soure span{ line-height:42px; height:42px; margin-right:10px; }
	.right_release li{ line-height:42px; }
	.input_width_2,.submit_btn{ height:38px; }
	.shop_img .big_small_img a{ height:42px; }
	</style>
</head>
<body>
	...
	<div class="i_businessman">
		...
		<div class="ibody">
			<div class="s_weiz">
				当前位置：
		<a href="<?php echo U('Member/Profile/index');?>" class="nav_active">商家中心</a>&nbsp;>发布开心任务
			</div>
			<!--s_weiz-->
      <?php include template('v2_merchant_left','member/common'); ?>
			<div class="s_right" >
				<div  class="title">发布开心任务</div>
				<div class="s_tryout5">
					<div class="part1">您发布的活动一旦系统审批，您将不能对此试用活动进行删除，开心任务活动平台不收取佣金,所以不退还剩余任务份数，请慎重！</div>
					<div  class="part2">
					...
					<div class="part3" >
						...
						<!-- radio_set_add -->
						<form action="<?php echo U('Member/merchantTask/task_add');?>" name="myform" method="post" id="myform">
							<ul class="right_release height_auto">
								<li class="shop_soure set_line_height width_100 float_left">
									...
									<input type="text" class="float_left input_width_1 height_100" name="info[title]" id="title" value="" placeholder="如：宝贝详情中宝贝材质中最后一句话是什么？"/>
								</li>
								<li class="shop_soure set_line_height width_100 float_left">
									<span class="font_size14 shop_value_name text_align_right">问题答案：</span>
									<input type="text" class="float_left input_width_1 height_100" name="info[answer]" id="answer" value="" placeholder="答案尽可能简洁，用户回答正确后获得您设置的佣金"/>
								</li>
								<li class="shop_soure width_100 float_left">
									<span class="font_size14 shop_value_name text_align_right">来源：</span>
									<?php echo $form::radio('info[source]', 1, $this->source);?></li>
							...
							$(document).ready(function() {
									...
									<ul class="shop_img ">
										<li class="big_small_img float_left">
											<span class="border_dddddd">
												<img src="<?php echo THEME_STYLE_PATH;?>style/images/signIn_14.jpg" alt="" />
												<input type="hidden" name="info[thumb]" value="" />
											</span>
								...
								<li class="shop_soure width_100 float_left">
									...
									<label>
										<input type="radio" value="1" name="info[sort]" checked/>
										综合
									</label>
									<label>
										<input type="radio" value="2" name="info[sort]"/>
										人气
									</label>
									<label>
										<input type="radio" value="3" name="info[sort]"/>
										销量
									</label>
									<label>
										<input type="radio" value="4" name="info[sort]"/>
										信用
									</label>
									<label>
										<input type="radio" value="5" name="info[sort]"/>
										最新
									</label>
									<label>
										<input type="radio" value="6" name="info[sort]"/>
										价格
									</label>
								</li>
								<li class="shop_soure set_line_height width_100 float_left">
									<span class="js_set_input font_size14 shop_value_name text_align_right">商品位置：</span>
									<input type="text" class="float_left input_width_1 height_100 " name="info[goods_address]" value="" id="goods_address" placeholder="请填写链接" />
								</li>
								<li class="shop_soure set_line_height width_100 float_left">
									<span class="js_set_input font_size14 shop_value_name text_align_right">掌柜旺旺：</span>
                                     
                                      <select  name="info[goods_wangwang]" style="width: 120px;margin-top:10px;">
...
<!-- 
								...
								<li class="shop_soure set_line_height width_100 float_left">
									...
									<input type="text" class="float_left input_width_2 height_100 " name="info[goods_number]" value="" id="goods_number"/>
									份（建议按照赚佣金活动分数的1:10进行投放，保证搜索转化效果）
								</li>
								<!-- 每份佣金 -->
								<li class="shop_soure set_line_height width_100 float_left">
									<span class="font_size14 shop_value_name text_align_right">每份佣金：</span>
									<input type="text" name="info[goods_price]" value="" id="goods_price" class="shop_cost1 float_left input_width_2 height_100 " />
									元（每份佣金最低0.1元，用户回答正确后获得此佣金）
								</li>
								<li class="shop_soure set_line_height width_100 float_left">
