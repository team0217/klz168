				...
				<div class="fr u_index_mess user_pd_1">
					...
					<?php if($state == 2) { ?>
						<ul class="sy_list_btn sy_list_btn_2 clear" style="height: auto; margin-top: 20px;">
						    ...
						    <li <?php if($state == 2 && $search_status == 7) { ?>class="active"<?php } ?>><a href="<?php echo U('Member/Order/v2_manage',array('mod'=>$mod,'state'=>'2','search_status'=>7));?>">订单完成<b><?php echo $finish_count;?></b></a></li>
									...
									<tr>
										<td class="clear">
											...
											<dl class="sy_tab_title fl">
												<dt><?php echo $r['product_info']['title'];?></dt>
												<dd>订单编号：<span class="c_333"><?php echo $r['trade_sn'];?></span></dd>
										...
										<td>
											<ul class="sy_zs_hb">
												...
												<?php if($r[product_info][goods_price] > 0) { ?>
										...
										<td>
											<ul class="sy_zs_hb sy_zs_btn">
					                            ...
					                            <?php if($r['status'] == 4) { ?>
					                               ...
					                               <li><a href="<?php echo U('Order/v2_trial_report',array('order_id'=>$r['id']));?>" target="_blank">修改好评报告</a></li>
					                               <?php } else { ?>
					                               <li><a href="javascript:;" onclick="order.fill_trade_no(<?php echo $r['id'];?><?php if($r['order_sn']) { ?>,'修改订单号'<?php } ?>);">修改订单号</a></li>
					                               <?php } ?>
					                            <?php } ?>
					                            ...
					                            <?php if($r['status'] == 8 && $mod=='trial'&& !$r['trial_report'] && $r['order_sn']) { ?>
					                                <li><a href="<?php echo U('Order/v2_trial_report',array('order_id'=>$r['id']));?>" target="_blank">填写好评报告</a></li>
					                            <?php } ?>
