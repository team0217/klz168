...
<html class="off" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title><?php echo get_seo('report_seo','report_title','');?></title>
    <meta name="keywords" content="<?php echo get_seo('report_seo','report_keyword','');?>">
    <meta name="description" content="<?php echo get_seo('report_seo','report_description','');?>
">
	 <link media="screen"  href="<?php echo THEME_STYLE_PATH;?>style/css2/styles.css" type="text/css" rel="stylesheet">
    <script src="<?php echo THEME_STYLE_PATH;?>style/js2/jquery-1.9.1.min.js" type="text/javascript" language="javascript"></script>
    <!--瀑布流JS-->
    <!--喜欢+1效果-->
    <script src="<?php echo THEME_STYLE_PATH;?>style/js2/jquery-AddIntOne.js" type="text/javascript"></script>
</head>
<body>
...
<div class="content">
    ...
    <div class="content-bd">
        ...
        <!--img 不加width和height google不兼容-->
            <?php require_once('E:\WWW\klz168.com/Application/Document\Taglib\document.class.php');$document_tag = new document();if(method_exists($document_tag, 'turn_rund')) {$data = $document_tag->turn_rund(array('order'=>'listorder ASC','where'=>'type=2','limit'=>'20',));} ?>
			<?php $n=1;if(is_array($data)) foreach($data AS $t) { ?>
                   <a href="<?php echo $t['url'];?>" target="_blank"><img src="<?php echo $t['image'];?>" alt="<?php echo $t['title'];?>" width="775" height="310"/></a>
			<?php $n++;}unset($n); ?>
                ...
                <div class="tj-back-bottom fleat jhbg-content">
                    <div class="ui-plist-v ui-plist-3" >
                        <ul class="fleat jhbg-ul" >
							<?php $n=1; if(is_array($result)) foreach($result AS $k => $r) { ?>
                            <li class="ui-figure-h ">
                                <p class="cover c<?php echo $k + 1;?>"></p>
                                <div class="pic">
                                    <a href="<?php echo U('Product/Index/report_show',array('id'=>$r[id]));?>" target="_blank"><img width="41" height="41" src="<?php echo getavatar($r[userid]);?>" alt=""></a>
                                </div>
                                <div class="cont">
                                    <h3><a href="<?php echo U('Product/Index/report_show',array('id'=>$r[id]));?>" target="_blank"><?php echo nickname($r[userid]);?></a></h3>
                                    <p><span class="font-red"><?php echo $r['count'];?></span>份精华报告,共<span class="font-red"><?php echo $r['buy_num'];?></span>份报告</p>
                                </div>
                            </li>
                            <?php $n++;}unset($n); ?>
                        </ul>
    ...
    <div class="content-bd top3">
        <div class="getjing">
            <div style="width: 440px" class="fleat">
                <span class="fleat block"><img src="<?php echo THEME_STYLE_PATH;?>style/images/xing.png"></span>
                <span style="margin: 4px;" class="fleat big block">
                    试用<b class="font-red">报告秀</b>
                </span>
                <a class="nohover jx-more">100%<?php echo C('WEBNAME');?>试客原创，全面实拍，客观描述试用情况！</a>
            </div>

            <div style="clear: both"></div>
            <div id="sault" class="container-fluid top3 sun_single_line">
			<?php require_once('E:\WWW\klz168.com/Application/Product\Taglib\product.class.php');$product_tag = new product();if(method_exists($product_tag, 'trail_report')) {$data = $product_tag->trail_report(array('limit'=>'10',));} ?>
			<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
				<div class="sault-box">
					<div class="sault_left">
						<div class="sault_te">
							<div class="sault_img">
								<a target="_blank" href="<?php echo U('product/index/report_show',array('id'=>$r['id']));?>">
									<img height="<?php echo $r['height'];?>" src="<?php echo $r['thumb'];?>" />
								</a>
							</div>
							<div class="sault_people">
								<div class="sault_avatar">
									<a target="_blank" href="<?php echo U('product/index/report_show',array('id'=>$r['id']));?>">
										<img height="32" src="<?php echo $r['product']['thumb'];?>" />
									</a>
								</div>
								<div class="sault_who">
                                    <a target="_blank" href="<?php echo U('product/index/report_show',array('id'=>$r['id']));?>">
                                       <span><?php echo $r['product']['title'];?>试用报告，</span></a>
								</div>
							</div>
							<div class="sault_content">
								<a target="_blank" href="<?php echo U('Product/Index/report_show',array('id'=>$r[id]));?>"><?php echo str_cut(strip_tags($r[content]), 70);?></a>
							</div>
						</div>
					</div>
				</div>
...
<script src="<?php echo THEME_STYLE_PATH;?>style/js2/jquery.masonry.min.js" type="text/javascript"></script>
</body>
</html>
  <!--试用报告焦点图JS-->
 <script src="<?php echo THEME_STYLE_PATH;?>style/js2/jquery.KinSlideshow-1.2.1.min.js" type="text/javascript"></script>
<script>
    //瀑布流
    var $container = $('#sault');
