    ...
    <tr>
    	<td>
    		<div class="explain-col">	
				...
				<br><br>
				返利新活动总数:<font color="green"><?php echo $new_rebate_count?$new_rebate_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				试用新活动总数：<font color="green"><?php echo $new_trial_count?$new_trial_count:0; ?></font>&nbsp;&nbsp;&nbsp;
				佣金新活动总数：<font color="green"><?php echo $new_commission_count?$new_commission_count:0; ?></font>&nbsp;&nbsp;&nbsp;
<!-- 				日赚任务新活动总数：<font color="green"><?php echo $new_task_count?$new_task_count:0; ?></font>&nbsp;&nbsp;&nbsp;
 -->			</div>
		</td>
		</tr>
    </tbody>
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">返利新活动</th>
			<th width="100">试用新活动</th>
			<th width="100">闪电佣金新活动</th>
<!-- 		<th width="100">日赚任务新活动</th>
 -->        <th width="118">统计时间</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo $r['day_rebate_new_mum'];?></td>
			<td align='center'><?php echo $r['day_trial_new_mum'] ?></td>
			<td align='center'><?php echo $r['day_commission_new_mum'] ?></td>
<!-- 			<td align='center'><?php echo $r['day_task_new_mum'] ?></td>
