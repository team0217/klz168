...
<form action="<?php echo U('updatename') ?>" method="post">
...
<td align="center"  width="150"><a href="<?php echo U('disable', array('style' => $v['dirname'])) ?>"><?php if($v['disable']){echo L("enable");}else{echo L('disable');}?></a> | <a href="<?php echo U('File/init',array('style' => $v['dirname'])) ?>"><?php echo L("detail")?></a> | <a href="<?php echo U('export', array('style' => $v['dirname'])) ?>"><?php echo L('export')?></a></td>
</tr>
<?php 
	endforeach;
endif;
